...
for i in range(len(df.columns)):
    ...
    # a[0:0 + 3]: Isso resulta em a[0:3], o que extrai os elementos nos índices 0, 1 e 2.
    # Portanto, a primeira iteração retorna [1, 2, 3].
    ...
    # Concatena as colunas 'coluna1' e 'coluna2' e preenche valores nulos com '0' fillna isso é responsavel por subst null por 0
