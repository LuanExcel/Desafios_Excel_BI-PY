...
test = pd.read_excel("Excel_Challenge_427 - Double Accumulative Cipher/Excel_Challenge_427 - Double Accumulative Cipher.xlsx", usecols="B", nrows=9)

input = pd.read_excel("Excel_Challenge_427 - Double Accumulative Cipher/Excel_Challenge_427 - Double Accumulative Cipher.xlsx", usecols="A", nrows= 9)
